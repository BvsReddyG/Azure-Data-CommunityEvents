...
DELTALAKE_SILVER_PATH = "/ml/bvsreddy/loan_by_state_delta"
...
# MAGIC USING delta
# MAGIC LOCATION '/ml/bvsreddy/loan_by_state_delta'
...
# MAGIC %sql 
# MAGIC DESCRIBE DETAIL delta.`/ml/bvsreddy/loan_by_state_delta`
...
# MAGIC %sh
# MAGIC ls -lt /dbfs/ml/bvsreddy/loan_by_state_delta/_delta_log/
...
# MAGIC %sh mkdir -p /dbfs/tmp/vyshus_eu_19_demo/census/ && wget -O /dbfs/tmp/vyshus_eu_19_demo/census/us_census_2010.csv https://pages.databricks.com/rs/094-YMS-629/images/us_census_2010.csv && ls -al /dbfs/tmp/vyshus_eu_19_demo/census/
...
# Include census data
census = spark.read.csv('/tmp/vyshus_eu_19_demo/census/us_census_2010.csv', sep=',', inferSchema=True, header=True)
